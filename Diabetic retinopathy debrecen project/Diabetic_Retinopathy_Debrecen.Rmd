...
km_data
```
Les informations ci-dessus nous donne accès aux barycentres de chaque variable, l'assignation de chaque individus à son cluster et la précision de notre clustering en regardant le ratio inter. Ce ratio inter est de 71,9%, ce qu'on peut considérer comme un résultat correct.
